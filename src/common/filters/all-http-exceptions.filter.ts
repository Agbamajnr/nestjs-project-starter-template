...
export class AllExceptionsFilter implements ExceptionFilter {
        ...
        if (host.getType() == 'http') {
            ...
            if (exception instanceof HttpException) {
                ...
                errorType = (errorResponse as any)?.errorType
            ...
            const errorResponse = this.getErrorResponse(status, errorMessage, errorType, request);
    ...
    private getErrorResponse = (
        ...
        request: Request,
    ): any => (new ResponseService().error({ statusCode: status, message: 'Error Occurred', url: request.url, error: errorMessage, errorType }));
